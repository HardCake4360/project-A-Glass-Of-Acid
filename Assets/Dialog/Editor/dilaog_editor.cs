...
public class dilaog_editor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        Dialog.anim = EditorGUILayout.ObjectField("Animator", Dialog.anim, typeof(Animator), true) as Animator;
        Dialog.playerAnim = EditorGUILayout.ObjectField("Player Animator", Dialog.playerAnim, typeof(Animator), true) as Animator;
